...
export default function App() {
  ...
  const { x, y, direction, setX, setY, move } = useMovement();
  ...
  const restrictPlayer = (x, y) => {
    let xEnd = window.innerWidth - (window.innerWidth % 20) + 20;
    let yEnd = window.innerHeight - (window.innerHeight % 20) + 20;
